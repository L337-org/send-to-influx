...
since 49.0.0 - this needs [Rust](https://rustup.rs/) and OpenSSL 3.x installed first (e.g.
`brew install openssl@3`). Apple Silicon and Linux are unaffected; this is a permanent upstream
change, not something to work around by pinning `cryptography` here.
